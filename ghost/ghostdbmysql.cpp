...
uint32_t MySQLAdminCount( void *conn, string *error, uint32_t botid, string server )
{
	...
	uint32_t Count = 0;
	string Query = "SELECT COUNT(*) FROM admins WHERE server='" + EscServer + "' AND botid='" + UTIL_ToString( botid ) + "'";
...
bool MySQLAdminCheck( void *conn, string *error, uint32_t botid, string server, string user )
{
	...
	bool IsAdmin = false;
	string Query = "SELECT * FROM admins WHERE server='" + EscServer + "' AND name='" + EscUser + "' AND botid='" + UTIL_ToString( botid ) + "'";
...
bool MySQLAdminRemove( void *conn, string *error, uint32_t botid, string server, string user )
{
	...
	string EscUser = MySQLEscapeString( conn, user );
	bool Success = false;
	string Query = "DELETE FROM admins WHERE server='" + EscServer + "' AND name='" + EscUser + "' AND botid='" + UTIL_ToString( botid ) + "'";
...
vector<string> MySQLAdminList( void *conn, string *error, uint32_t botid, string server )
{
	...
	string Query = "SELECT name FROM admins WHERE server='" + EscServer + "' AND botid='" + UTIL_ToString( botid ) + "'";
...
uint32_t MySQLBanCount( void *conn, string *error, uint32_t botid, string server )
{
	string EscServer = MySQLEscapeString( conn, server );
	uint32_t Count = 0;
	string Query = "SELECT COUNT(*) FROM bans WHERE server='" + EscServer + "' AND botid='" + UTIL_ToString( botid ) + "'";
...
CDBBan *MySQLBanCheck( void *conn, string *error, uint32_t botid, string server, string user, string ip )
{
	...
	if( ip.empty( ) )
		Query = "SELECT name, ip, DATE(date), gamename, admin, reason FROM bans WHERE server='" + EscServer + "' AND name='" + EscUser + "' AND botid='" + UTIL_ToString( botid ) + "'";
	else
...
bool MySQLBanRemove( void *conn, string *error, uint32_t botid, string server, string user )
{
	...
	string EscUser = MySQLEscapeString( conn, user );
	bool Success = false;
	string Query = "DELETE FROM bans WHERE server='" + EscServer + "' AND name='" + EscUser + "' AND botid='" + UTIL_ToString( botid ) + "'";
...
bool MySQLBanRemove( void *conn, string *error, uint32_t botid, string user )
{
	...
	string EscUser = MySQLEscapeString( conn, user );
	bool Success = false;
	string Query = "DELETE FROM bans WHERE name='" + EscUser + "' AND botid='" + UTIL_ToString( botid ) + "'";
...
vector<CDBBan *> MySQLBanList( void *conn, string *error, uint32_t botid, string server )
{
	...
	string Query = "SELECT name, ip, DATE(date), gamename, admin, reason FROM bans WHERE server='" + EscServer + "' AND botid='" + UTIL_ToString( botid ) + "'";
